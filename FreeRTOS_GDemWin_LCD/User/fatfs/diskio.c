...
//    printf("disk_read:%lx %d \r\n", sector, count);
    ...
    case SPI_FLASH:
        OSPI_Flash_Read(sector * SPI_FLASH_SECTOR_SIZE, (uint8_t *)buff, count * SPI_FLASH_SECTOR_SIZE);
        return RES_OK;
...
//    printf("disk_write:%lx %d\r\n", sector, count);
    ...
    case SPI_FLASH:
        ...
        OSPI_Flash_Erase_Sector(write_addr);
        OSPI_Flash_Write(write_addr, (uint8_t *)buff, count * SPI_FLASH_SECTOR_SIZE);
        return RES_OK;
